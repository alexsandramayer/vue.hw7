<template>
    <div class="categories__item">
        <img class="categories__item_img" :src="article.img" alt="image" @click="clickFav(article.id)">
        <span class="categories__item_star"  v-show="article.favorite"> 
        ...
        <div class="categories__item_info">
            <div class="categories__item_titles">
                <h3 class="categories__item_title">{{ article.title }}</h3>
                <h4 class="categories__item_subtitle">{{ article.subtitle }}</h4>
            </div>
            <a href="#" class="categories__item_btn"><svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70" fill="none">
