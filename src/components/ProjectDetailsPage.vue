<template>
    ...
    <div class="banner banner__projectdetails">
    </div>

    <section class="projectdetails__block container">
        <div class="projectdetails__content" v-for="item in    getProjectDetContent" :key="index">
            <h1 class="projectdetails__title">{{ item.title }}</h1>
        ...
        <ProjectDetailsSlider :slider-pictures="getSliderPictures"/>
...
import ProjectDetailsSlider from './ProjectDetailsSlider.vue';
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['getProjectDetContent', 'getSliderPictures'])
        }
    }
</script>
